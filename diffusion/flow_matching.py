...
class FlowMatching:
    ...
    def __init__(
        ...
        *,
        ...
        #Include a flag to indicate that flow matching does not use discrete timesteps, 
        # which is important for the training loop and schedule sampler
        self.uses_discrete_timesteps = False
